...
# Logo strip for the cover: Agenta plus one recognizable brand per remaining lane.
# Avoid personal-photo avatars.
COVER_ORGS = [
...
# Right logo panel: 2 cols x 3 rows of 84px tiles (Agenta is the first tile).
