...
- [General Input](https://www.generalinput.com) - Platform where teams describe processes in plain English and an AI agent builds, runs, and maintains workflows, apps, and skills across connected business tools. License: proprietary. Hosting: vendor-hosted; managed on-prem deployment available.
